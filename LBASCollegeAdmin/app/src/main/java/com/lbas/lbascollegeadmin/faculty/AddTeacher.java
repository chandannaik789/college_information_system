...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select category","Principal","Computer Science & Engineering","Information Science & Engineering",
                ...
                "Department of Basic Science & Humanities","Department of Kannada","Department of English","Department of Hindi","Department of Sanskrit","Department of Physical Education"};
    ...
    private void insertData() {
        reference = databaseReference.child(category);
